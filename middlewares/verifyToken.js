...
async function verifyToken(req, res, next) {
    ...
    const accessTokenPayload = jwt.decode(requestAccessToken);
    const refreshTokenPayload = jwt.decode(requestRefreshToken);
    ...
    /** Then check if they are logged in from another device or not */
    ...
    /** If the user is not logged in from another device */
